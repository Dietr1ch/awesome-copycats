...
run_once({
  ...
  "xmodmap ~/.Xmodmap",
  "unclutter -root -idle 1 -jitter 5 -noevents"
})
...
local editor       = os.getenv("EDITOR") or "remacsclient -c -nw"
local gui_editor   = os.getenv("VISUAL") or "remacsclient -c"
local browser      = "firefox"
local guieditor    = "remacsclient -c"
-- local scrlocker    = "loginctl lock-session"
local scrlocker    = "xlock"

awful.util.terminal = terminal
awful.util.tagnames = { "!", "Main", "Web", "Comms", "Misc" }
...
-- {{{ Key bindings
-- local global_quake = lain.util.quake({
--   app = "xterm",
--   height = 0.6,
--   --app = "alacritty",
--   --argname = "-t %s",
...
globalkeys = my_table.join(
    ...
    awful.key({ altkey, ctrl }, "+", function () lain.util.useless_gaps_resize(1) end,
    ...
    --awful.key({ modkey, }, "'", function () global_quake:toggle() end),
    ...
    awful.key({ modkey }, "u", function () awful.spawn("dolphin") end,
...
awful.rules.rules = {
    ...
    -- Set Firefox/Chromium to always map on the "browser" tag.
    -- { rule = { class = "Firefox" },
